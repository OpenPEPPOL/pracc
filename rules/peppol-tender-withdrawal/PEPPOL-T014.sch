...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        ...
        <rule context="ubl:TenderReceipt">
            ...
            <assert id="eSENS-T014-S305" flag="warning" test="not(cbc:ProfileExectuionID)">[eSENS-T014-S305] ProfileExecutionID SHOULD NOT be used.
            </assert>
            ...
            <assert id="eSENS-T014-S310" flag="warning" test="not(cbc:ConctractName)">[eSENS-T014-S310] ContractName SHOULD NOT be used.
            </assert>
            <assert id="eSENS-T014-S312" flag="warning" test="not(cbc:Note)">
                [eSENS-T014-S312] Note SHOULD NOT be used.
            </assert>
            <assert id="eSENS-T014-S313" flag="warning" test="3 > count(cac:TenderDocumentReference)">[eSENS-T014-S313] TenderDocumentReference SHOULD NOT be used more than twice.
            </assert>
        ...
        <rule context="ubl:TenderReceipt/cbc:UBLVersionID">
            ...
            <assert id="eSENS-T014-S302" flag="warning" test="not(./@*)">[eSENS-T014-S302]
        ...
        <rule context="ubl:TenderReceipt/cbc:CustomizationID">
            <assert id="eSENS-T014-R002" flag="fatal"
                    test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t014:1.0'">
                [eSENS-T014-R002] CustomizationID value MUST be
                'urn:fdc:peppol.eu:prac:trns:t014:1.0'
            </assert>
            <assert id="eSENS-T014-S303" flag="warning" test="not(./@*)">[eSENS-T014-S303]
        ...
        <rule context="ubl:TenderReceipt/cbc:ProfileID">
            <assert id="eSENS-T014-R003" flag="fatal"
                    test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p007:1.0'">[eSENS-T014-R003] ProfileID
                value MUST be 'urn:fdc:peppol.eu:prac:bis:p007:1.0'
            </assert>
            <assert id="eSENS-T014-S304" flag="warning" test="not(./@*)">[eSENS-T014-S304]
        ...
        <rule context="ubl:TenderReceipt/cbc:ID">
            ...
            <assert id="eSENS-T014-S306" flag="warning" test="./@*[name()='schemeURI']">[eSENS-T014-S306] A Tender Withdrawal Receipt Notification Identifier SHOULD NOT have
        ...
        <rule context="ubl:TenderReceipt/cbc:ContractFolderID">
            <assert id="eSENS-T014-S309" flag="warning" test="not(./@*)">[eSENS-T014-S309]
        ...
        <rule context="ubl:TenderReceipt/cac:TenderDocumentReference/cbc:ID">
            ...
            <assert id="eSENS-T014-S315" flag="warning" test="./@*[name()='schemeURI']">[eSENS-T014-S306] A Tender Document Reference Identifier SHOULD NOT have
                any attributes but schemeURI
            </assert>
        ...
        <rule context="ubl:TenderReceipt/cac:TenderDocumentReference/cac:Attachment">
            <assert id="eSENS-T014-S316" flag="warning" test="count(./*)-count(./cac:ExternalReference)=0">[eSENS-T014-S316] Attachment SHOULD NOT contain any elements but
                ExternalReference
            </assert>
        </rule>
        ...
        <rule context="ubl:TenderReceipt/cac:TenderDocumentReference/cac:Attachment/cac:ExternalReference">
            <assert id="eSENS-T014-S317" flag="warning"
                    test="count(./*)-count(./cbc:DocumentHash)-count(./cbc:HashAlgorithmMethod)=0">[eSENS-T014-S317] Attachment/ExternalReference SHOULD NOT contain any
        ...
        <rule context="ubl:TenderReceipt/cac:TenderDocumentReference/cac:Attachment/cac:ExternalReference/cbc:DocumentHash">
            ...
            <assert id="eSENS-T014-S318" flag="warning" test="not(./@*)">[eSENS-T014-S318]
        ...
        <rule context="ubl:TenderReceipt/cac:TenderDocumentReference/cac:Attachment/cac:ExternalReference/cbc:HashAlgorithmMethod">
            ...
            <assert id="eSENS-T014-S319" flag="warning" test="not(./@*)">[eSENS-T014-S319]
        ...
        <rule context="ubl:TenderReceipt/cac:TenderDocumentReference/cac:IssuerParty">
            <assert id="eSENS-T014-S320" flag="warning" test="count(./*)-count(./cbc:EndpointID)=0">[eSENS-T014-S320] IssuerParty SHOULD NOT contain any elements but EndpointID.
            </assert>
        </rule>
        ...
        <rule context="cbc:EndpointID">
            ...
            <assert id="eSENS-T014-S321" flag="warning" test="./@*[name()='schemeID']">[eSENS-T014-S321] EndpointID SHOULD NOT have any attributes but schemeID
            </assert>
        </rule>
        ...
        <rule context="ubl:TenderReceipt/cac:SenderParty | ubl:TenderReceipt/cac:ReceiverParty">
            ...
            <assert id="eSENS-T014-S324" flag="warning" test="count(./cac:PartyIdentification) = 1">[eSENS-T014-S324] PartyIdentification SHOULD be used exactly once.
            </assert>
            <assert id="eSENS-T014-S326" flag="warning" test="2 > count(./cac:PartyName)">[eSENS-T014-S326] PartyName SHOULD NOT be used more than once.
            </assert>
        </rule>
        ...
        <rule context="cac:PartyIdentification/cbc:ID">
            ...
            <assert id="eSENS-T014-S325" flag="warning" test="./@*[name()='schemeID']">[eSENS-T014-S325] PartyIdentifier SHOULD NOT have any further attributes but
                schemeID
            </assert>
        </rule>

        <rule context="cbc:Name">
            <assert id="eSENS-T014-S327" flag="warning" test="not(./@*)">[eSENS-T014-S327]
