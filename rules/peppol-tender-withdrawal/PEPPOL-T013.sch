...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        ...
        <rule context="ubl:TenderWithdrawal">
            ...
            <report id="eSENS-T014-S305" flag="warning" test="(cbc:ProfileExectuionID)"><value-of
                    select="$syntaxError"/>[eSENS-T014-S305] ProfileExecutionID SHOULD NOT be used.
            </report>
            <report id="eSENS-T014-S307" flag="warning" test="(cbc:CopyIndicator)">
                <value-of select="$syntaxError"/>
                [eSENS-T014-S307] CopyIndicator SHOULD NOT be used.
            </report>
            <report id="eSENS-T014-S308" flag="warning" test="(cbc:UUID)">
                <value-of select="$syntaxError"/>
                [eSENS-T014-S308] UUID SHOULD NOT be used.
            </report>
            <report id="eSENS-T014-S310" flag="warning" test="count (cbc:ConctractName) &gt; 1"><value-of
                    select="$syntaxError"/>[eSENS-T014-S310] ContractName SHOULD NOT be used more than once.
            </report>
            <report id="eSENS-T014-S312" flag="warning" test="(cbc:Note)">
                <value-of select="$syntaxError"/>
        ...
        <rule context="ubl:TenderWithdrawal/cbc:CustomizationID">
            <assert id="eSENS-T014-R002" flag="fatal"
                    test="normalize-space(.) = 'urn:www.cenbii.eu:transaction:biitrdm089:ver3.0:extended:urn:fdc:peppol.eu:2021:pracc:t013:ver1.0'">
                [eSENS-T014-R002] CustomizationID value MUST be
                'urn:www.cenbii.eu:transaction:biitrdm089:ver3.0:extended:urn:fdc:peppol.eu:2021:pracc:t013:ver1.0'
            </assert>
        ...
        <rule context="ubl:TenderWithdrawal/cbc:ProfileID">
            ...
            <report id="eSENS-T014-S304" flag="warning" test="./@*"><value-of select="$syntaxError"/>[eSENS-T014-S304]
        ...
        <rule context="ubl:TenderWithdrawal/cbc:WithdrawOfferIndicator">
            <report id="eSENS-T014-S311" flag="warning" test="./@*"><value-of select="$syntaxError"/>[eSENS-T014-S310]
        ...
        <rule context="ubl:TenderWithdrawal/cac:TenderDocumentReference/cac:Attachment/cac:ExternalReference/cbc:HashAlgorithmMethod">
            ...
            <report id="eSENS-T014-S319" flag="warning" test="./@*"><value-of select="$syntaxError"/>[eSENS-T014-S319]
        ...
        <rule context="ubl:TenderWithdrawal/cac:TenderNotificationDocumentReference/cbc:ID">
            <assert id="eSENS-T014-R017" flag="fatal"
                    test="matches(normalize-space(.),'^[a-fA-F0-9]{8}(\-[a-fA-F0-9]{4}){3}\-[a-fA-F0-9]{12}$')">
                [eSENS-T014-R013] The tender notification reference Identifier MUST reference the Tender ID expressed in
                a UUID
                syntax (RFC 4122)
            </assert>
            <report id="eSENS-T014-S320" flag="warning" test="./@*"><value-of select="$syntaxError"/>[eSENS-T014-S315]
                TenderDocumentReference Identifier SHOULD NOT contain any attributes.
            </report>
        </rule>
        ...
        <rule context="ubl:TenderWithdrawal/cac:ContractingParty/cac:Party">
            <assert id="eSENS-T014-R018" flag="fatal" test="(./cac:PartyIdentification) and (./cbc:EndpointID)">
                [eSENS-T014-R017] A Tender Withdrawal MUST identify the Contracting Party by its party and
        ...
        <rule context="ubl:TenderWithdrawal/cac:TendererParty">
            <assert id="eSENS-T014-R020" flag="fatal" test="(./cac:PartyIdentification) and (./cbc:EndpointID)">
                [eSENS-T014-R017] A Tender Withdrawal MUST identify the Tenderer Party by its party and
                endpoint identifiers.
            </assert>
        </rule>
        ...
        <rule context="ubl:TenderWithdrawal/cac:ContractingParty/cac:Party | ubl:TenderWithdrawal/cac:TendererParty">
            <assert id="eSENS-T014-S323" flag="warning"
                ...
                [eSENS-T014-S323] ContractingParty or TendererParty SHOULD NOT contain any
            ...
            <report id="eSENS-T014-S326" flag="warning" test="count(./cac:PartyName) &gt; 1"><value-of
        ...
        <rule context="cac:PartyIdentification/cbc:ID">
            ...
            <report id="eSENS-T014-S325" flag="warning" test="./@*[not(name()='schemeID')]"><value-of
        ...
        <rule context="cbc:Name">
            <report id="eSENS-T014-S327" flag="warning" test="./@*"><value-of select="$syntaxError"/>[eSENS-T014-S327]
                Name SHOULD NOT contain any attributes.
            </report>
        </rule>

        <rule context="ubl:TenderWithdrawal/cac:ContractingParty/cac:Party/cac:PostalAddress">
            <assert id="eSENS-T014-S328" flag="warning"
                ...
                [eSENS-T014-S323] PostalAddress SHOULD NOT contain any
        ...
        <rule context="ubl:TenderWithdrawal/cac:ContractingParty/cac:Party/cac:PostalAddress/cac:Country">
            <assert id="eSENS-T014-S329" flag="warning"
                    test="count(./*) - count(./cac:IdentificationCode) = 0">
                [eSENS-T014-S323] Country SHOULD NOT contain any elements but IdentificationCode
            </assert>
        </rule>

        <rule context="ubl:TenderWithdrawal/cac:ContractingParty/cac:Party/cac:Contact">
            <assert id="eSENS-T014-S330" flag="warning"
                    test="count(./*) - count(./cac:Name) - count(./cac:Telephone) - count(./cac:Telefax) - count(./cac:ElectronicMail) = 0">
                [eSENS-T014-S323] Contact SHOULD NOT contain any elements but Name, Telephone, Telefax, ElectronicMail
            </assert>
        </rule>
