...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        ...
        <rule context="ubl:Enquiry">
            ...
            <assert id="PEPPOL-T008-R010" flag="fatal" test="(cbc:IssueTime)">[PEPPOL-T008-R010] A Tendering Answer MUST have an issue time.</assert>
            <assert id="PEPPOL-T008-R013" flag="fatal" test="count(cbc:Description) > 0">[PEPPOL-T008-R013] A Tendering Answer MUST have a Tendering response.</assert>
        ...
        <rule context="ubl:Enquiry/cac:RequestorParty">
            <assert id="PEPPOL-T008-R014" flag="fatal" test="(./cac:PartyIdentification) and (./cbc:EndpointID)">[PEPPOL-T008-R014] A Tendering Answer MUST identify the Economic Operator by its party identifier and its endpoint identifier.</assert>
            <assert id="PEPPOL-T008-R019" flag="warning" test="(./cac:PartyName)">[PEPPOL-T008-R019] A Tendering Answer SHOULD include the name of the Economic Operator.</assert>
        ...
        <rule context="ubl:Enquiry/cac:ResponderParty">
            <assert id="PEPPOL-T008-R020" flag="fatal" test="(./cac:PartyIdentification) and (./cbc:EndpointID)">[PEPPOL-T008-R020] A Tendering Answer MUST identify the contracting body by its party identifier and its endpoint identifier.</assert>
