...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <pattern>
        ...
        <rule context="ubl:Tender/cbc:ProfileID">
            <assert id="eSENS-T005-R003" flag="fatal" test="normalize-space(.) = 'urn:www.cenbii.eu:profile:bii54:ver3.0'">[eSENS-T005-R003] ProfileID value MUST be 'urn:www.cenbii.eu:profile:bii54:ver3.0'</assert>
