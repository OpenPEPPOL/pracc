...
The contracting body answers the questions and sends the answers to all economic operators that have expressed interest in the tendering procedure.  
...
| Remarks | All economic operators that have expressed interest shall receive (or may access) the answers.
|===
