...
For the {peppol} BIS all {peppol} non-functional requirements are applicable as mentioned in {name-profile-org} and ESPD Exchange Data Model. When adopting the {peppol} BIS implementers must comply to these requirements.
