...
| The receiver of a message or the sender of a search notice sends a Tendering Message Response to the sender of a message or the receiver of search notice.
