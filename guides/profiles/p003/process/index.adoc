...
If the call for tender was issued as part of an open procedure, an (unstructured) ESPD or other qualification document needs to be sent as an attachment to the tender. The contracting body notifies the economic operator of having received the Tender. +
