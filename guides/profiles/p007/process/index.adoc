...
image::../images/processTW.png[align="center", width="800"]
...
| Receive Tender Withdrawal receipt notification | Economic operator | The economic operator receives the confirmation.
