...
| BiiTrdm045 | TenderReceipt | CA receives the tender and sends acknowledgement to EO | urn:www.cenbii.eu:transaction:biitrdm045:ver3.0:extended:urn:www.peppol.eu:bis:peppol54a:ver1.0
| T006 | TenderReceipt | CA receives the tender and sends acknowledgement to EO | #**urn:www.cenbii.eu:transaction:biitrdm045:ver3.0:extended:urn:www.peppol.eu:bis:t006:ver1.0**#
|===
