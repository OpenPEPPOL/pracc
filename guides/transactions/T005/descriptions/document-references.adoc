...
[source,xml,indent=0]
----
include::../{xml-doc-fil}[tags=ContractFolderID]
----
...
[source,xml,indent=0]
----
include::../{xml-doc-fil}[tags=DocumentReference1]
----
...
[source,xml,indent=0]
----
include::../{xml-doc-fil}[tags=DocumentReference2]
----
...
.Document Type Code
----
include::../{xml-doc-fil}[tags=DocumentTypeCode]
----
...
----
include::../{xml-doc-fil}[tags=Provided_ESPD]
----
