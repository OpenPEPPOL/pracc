...
<.> This is the UBL code of the type of document you searched for. Possible values can be taken from the list "_UBL Document Schema_", which has to be deposited in the type-attribute of the slot.
