...
<.> The value for the specification identification is always "_urn:www.cenbii.eu:transaction:biitrdm100:ver3.0:extended:urn:fdc:peppol.eu:2021:pracc:t012:ver1.0_", just like in the given example.
...
<.> The value for the business process type identifier is always "_urn:fdc:peppol.eu:2020:pracc:p006:01:1.0_", just like in the given example.
