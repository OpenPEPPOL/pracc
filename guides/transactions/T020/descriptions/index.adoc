...
[source,xml,indent=0]
....
include::../files/TendererQualificationResponse-doc.xml[tags=ref-contract-folder-id;ref-answer;answer]
....
...
[source,xml,indent=0]
....
include::../files/TendererQualificationResponse-doc.xml[tags=ref-contract-folder-id;ref-file;file]
....
