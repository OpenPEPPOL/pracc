...
== Qualification document reference

The qualification reception confirmation contains the reference to the qualification document sent by the economic operator. The contracting authority should refer to the qualification document by using the document hash and the hash algorithm method used.
...
== Document Type Code (Qualification)
