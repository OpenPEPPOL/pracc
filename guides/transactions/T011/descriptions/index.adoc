...
=== Parameter maxResults and startIndex
...
<.> The value for the specification identification is always "_urn:fdc:peppol.eu:2021:pracc:t011:1.0_", just like in the given example.
...
<.> The value for the business process type identifier is always "_urn:fdc:peppol.eu:2021:pracc:p006:1.0_", just like in the given example.
