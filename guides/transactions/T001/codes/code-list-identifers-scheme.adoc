...
policy 8, +
see also link:http://wiki.ds.unipi.gr/display/ESENSPILOTS/5.1.1+%2D+Pilot+Specifications+%2D+eDelivery+guide+for+eTendering[e-SENS eDelivery guide for eTendering]  | cbc:EndpointID/@schemeID
