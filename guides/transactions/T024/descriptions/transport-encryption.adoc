...
Alternatively a provided document URI could be used to reference the encryption certificate.
...
[source,xml,indent=0]
.Example of the CfT (partly) for transporting the encryption certificate with cbc:URI
