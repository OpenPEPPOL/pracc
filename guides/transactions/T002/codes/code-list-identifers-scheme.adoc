...
| Economic operator electronic address identifier | chemeID attribute is mandatory and must use values from https://docs.peppol.eu/poacc/upgrade-3/codelist/eas/[EAS codes] | cac:EconomicOperatorParty/cac:Party/cbc:EndpointID/@schemeID
...
| Economic operator identifier | schemeID attribute is mandatory and must use values from https://docs.peppol.eu/poacc/upgrade-3/codelist/ICD/[ICD codes] |  cac:EconomicOperatorParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID
