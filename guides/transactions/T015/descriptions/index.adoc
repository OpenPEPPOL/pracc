...
In case the publication of the attached notices should not be with the sending of this transaction, use the field to enter a preferred publication date. Otherwise, this field should not be included as well as when no publication is preferred.
[source,xml,indent=0]
....
