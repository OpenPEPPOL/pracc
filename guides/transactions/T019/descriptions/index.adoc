...
[source,xml,indent=0]
....
include::../files/TendererQualification-doc.xml[tags=contract-folder-id;question-contract-folder-id]
....
...
[source,xml,indent=0]
....
include::../files/TendererQualification-doc.xml[tags=lot;question-lot]
....
