...
The example below demonstrates the use of the `cac:ProcurementProject` class for a tendering process without lots. The structured information does not convey economic information. It is used to describe the project, to provide classification codes using the Common Procurement Vocabulary link:https://op.europa.eu/en/web/eu-vocabularies/dataset/-/resource?uri=http://publications.europa.eu/resource/dataset/cpv[(CPV codes)] or Common Procurement Vocabulary Supplement using the codelist for Common Procurement Vocabulary link:https://op.europa.eu/en/web/eu-vocabularies/dataset/-/resource?uri=http://publications.europa.eu/resource/dataset/cpvsuppl[(CPV Supplement codes)]. and the location where the project will be executed using the Nomenclature of Territorial Units for Statistics link:https://op.europa.eu/en/web/eu-vocabularies/dataset/-/resource?uri=http://publications.europa.eu/resource/dataset/nuts[(NUTS codes)].
