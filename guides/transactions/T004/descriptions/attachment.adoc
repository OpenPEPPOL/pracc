...
Find below an example on how to define a provided document reference. In this example, the contents of the coded elements DocumentTypeCode and DocumentStatusCode have been defined with coded values.
