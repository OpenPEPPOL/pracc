...
.Transaction business requirements of Trdm083
|===
| ID| Requirement
...
| tbr83-008| "The address to which tenders or requests to participation shall be submitted must be included in the call for tenders, including encryption parameters and time-stamping: Art 22 and 53 of Directive +
2014/24/EC."
