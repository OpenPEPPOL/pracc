...
:link-eDelivery: https://docs.peppol.eu/pracc/files/BIS-eDelivery-guide-for-pre-award-v1.2.pdf[BIS eDelivery guide for pre-award]
:link-eDocument: https://docs.peppol.eu/pracc/files/BIS-eDocuments-guide-for-pre-award-v1.2.pdf[BIS eDocuments guide for pre-award]
